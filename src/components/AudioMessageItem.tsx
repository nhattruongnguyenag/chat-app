...
export default function AudioMessageItem() {
  return (
    <div className='col-start-1 col-end-7 p-3 rounded-lg'>
      <div className='flex flex-row items-center'>
        ...
        <div className='relative ml-3 text-sm bg-white py-2 px-2 shadow rounded-xl'>
          <div className='flex flex-row items-center'>
            <button className='flex items-center justify-center bg-indigo-600 hover:bg-indigo-800 rounded-full h-8 col-end-6'>
              <svg
